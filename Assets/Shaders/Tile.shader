	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float2 rotator53 = mul( uv032 - float2( 0.5,0.5 ) , float2x2( cos53 , -sin53 , sin53 , cos53 )) + float2( 0.5,0.5 );
...
/*ASEBEGIN
Version=18100
94;129;1703;833;1906.09;250.1104;1.614671;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;54;-1280,352;Inherit;False;Property;_Angle;Angle;5;1;[PerRendererData];Create;True;0;0;False;0;False;3.14;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;32;-1108,61;Inherit;True;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RadiansOpNode;56;-1120,352;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=CF52A00427379DFC79B9776AED7BDC6649118699